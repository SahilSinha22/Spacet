...
<div
    ...
    >
      ...
      <div className="  2xl:w-auto w-auto    xl:w-auto xl:h-auto xl:text-xl 2xl:text-2xl sm:mr-3 sm:w-auto lg:w-[696px]  flex flex-col   px-4 pt-4 bg-blue-500 mx-2 my-4 space-y-4  ">
