...
const bar = () => {
  return (
    <nav className=" text-xs  h-auto  md:w-auto xl:w-auto xl:p-0 xl:m-0    2xl:justify-end   xl:justify-end bg-blue-600  sm:w-auto sm:p-0 sm:justify-start  sm:font-small sm:flex-col  flex flex-row border-gray-200 dark:bg-gray-900  max-h-14 items-center justify-end  ">
      <div className=" 2xl:ml-40 p-2 sm:p-2 xl:mr-0  2xl:mr-0 xl:text-lg 2xl:text-2xl flex flex-row justify-end   2xl:justify-end  lg:justify-end xl:justify-end  md:items-center sm:justify-start   sm:text-xs all sm:mt-1  sm:ml-1 sm:text-start  sm:items-center  sm:flex-col items-center mr-0 max-w-screen-xl    ">
        <div className="    text-xs xl:text-lg xl:pr-0  xl:mr-0  xl:p-0 xl:m-0 2xl:text-2xl flex flex-row  sm:ml-8 2xl:justify-end items-center xl:justify-end lg:justify-end md:w-full md:justify-end  sm:pl-0 lg:mx-2 sm:m-0 sm:text-xs  rtl:space-x-reverse ">
          ...
          <img src="19.svg" className="h-5 sm:h-8 mx-1 xl:text-2xl 2xl:h-85   md:mx-2 sm:mb-2 " alt="" />
          <img src="FlagIndia.svg" className=" h-3 sm:h-5 mr-1 md:mx-2  mb-2" alt="" />{" "}
          <a
            href="tel:5541251234"
          ...
          <img src="logo.svg" className="h-4 sm:h-7 mx-1 md:mx-2 mb-2" alt="Whatsapp" />
          <img src="Flag.svg" className="h-3 sm:h-5 mx-1 md:mx-2 mb-2" alt="" />
          <a
            href="tel:5541251234"
